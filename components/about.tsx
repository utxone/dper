...
export default function About() {
  return (
    <>
      <div
        className="mt-48 text-xl text-love-500 cursor-pointer bg-black rounded-sm px-3 transition-all ease-in-out delay-150"
      >
        [ about ]
      </div>
      <div
      ...
      >
        <h2 className="w-full md:w-[800px] font-mono leading-8 text-stone-800 text-center text-pretty">
