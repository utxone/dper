    ...
    <>
      ...
      >
        <h2 className="w-full md:w-[800px] font-mono text-center leading-8 text-white">
          {`{op:depr}`} is a project to give the credit to brc-20 ticker
          deployers, there are more than 60000 tickers deployed, those ticker
          would not exist if there is no deployer. If you have deployed brc-20
          ticker before block <span className="decoration">[819394]</span> , you
          can claim 1,000 depr, all depr is available to claim.{" "}
